...
class SwiperCodeTest extends StatefulWidget {
  ...
  @override
  SwiperCodeTestState createState() => SwiperCodeTestState();
}

class SwiperCodeTestState extends State<SwiperCodeTest> {
